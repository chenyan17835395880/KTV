...
function loaded() {
    ...
    $('input').on('keyup', function () {
        ...
        $.each(lis, function (index, value) {
            ...
            all = { oname: attr[2], time: attr[3], sname: attr[2].split('-')[1], pinyin: ConvertPinyin(attr[2]), img: attr[5].split(';')[1] };
            pyarr.push(all);
        });
        var data = pyarr.filter(function (element) {
            return element.oname.includes(value) || element.pinyin.includes(value);
        });
        render(data);
        myScroll = new IScroll('.wrapper', {
            click: true //配置项
    ...
    $.each(lis, function (index, value) {
        var attr = $(value).attr('dataall').split(',');
        all1 = { oname: attr[2], time: attr[3], sname: attr[2].split('-')[1], pinyin: ConvertPinyin(attr[2].split('-')[0]), img: attr[5].split(';')[1] };
        pyall.push(all1);
    });
    render(pyall);
    myScroll = new IScroll('.wrapper', {
