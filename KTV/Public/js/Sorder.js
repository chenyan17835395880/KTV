...
function loaded() {
    ...
    var main = $('.main');
    $.ajax({
        url: '/KTV/index.php/music/Sorder',
    ...
    function rander(obj, data) {
        ...
        $.each(data, function (index, value) {
            console.log(value);
            obj.html(str += '\n                    <a href="/KTV/index.php/music/play?singertype=' + value.singertype + '">\n                        <li id="' + value.oid + '" >\n                             <div class="left">\n                                 <div class="left-one"></div>\n                                 <div class="left-two">\n                                     <img src="' + value.img + '" alt="">\n                                 </div>\n                             </div>\n                             <div class="geming">\n                                 <p>' + value.oname + '</p>\n                                 <p>04"25\'</p>\n                             </div>\n                             <div class="tianjia">\n                                 <img src="/KTV/Public/img/btnd.png" alt="" class="del">\n                             </div>\n                             <div class="tianjia">\n                                 <img src="/KTV/Public/img/stick.png" alt="" class="top">\n                             </div>\n                         </li>\n                    </a>\n                ');
        });
    }
}