...
$(function () {
    ...
    $(window).on('hashchange', function () {
        ...
        if (location.hash == '#list') {
            $.ajax({
                url: '/KTV/index.php/singermanager/show', //发送数据
                dataType: 'json',
    ...
    sub.on('click', function () {
        ...
        /*console.log(data)//FormData {}
                        // __proto__: FormData*/
        $.ajax({
            url: '/KTV/index.php/singermanager/insert',
            type: 'post',
            data: data,
            success: function success(data) {
                if (data == "ok") {
    ...
    image.onchange = function () {
        ...
        /* /!*console.log(this.files);*!/
         ...
         reader.onload=function(e){
             ...
             xml.open('post','/KTV/index.php/singermanager/upload',true);
    ...
    tbody.on('click', '.btn', function () {
        ...
        var that = this;
        $.ajax({
            url: '/KTV/index.php/singermanager/delete',
            data: { id: id }, ///////////?????????????
            success: function success(data) {
                if (data == 'ok') {
    ...
    tbody.on('blur', 'input', function () {
        ...
        var id = $(this).parents('tr').attr('id');
        $.ajax({
            url: '/KTV/index.php/singermanager/update',
